...
export const PriorityBets = () => {
    return (
        <Flex h="400px" flexDir="column">
            ...
            <Flex w="100%" p="7px 18px 0 0" alignItems="center" mt="9px">
                <Text fontSize="16px" color="#3047FE" fontWeight="600" ml="18px">
                    !!
                </Text>
                <Flex border="1px solid #FFFFFF" w="548px" h="101px" ml="22px" borderRadius="6px" cursor="pointer">
            ...
            <Flex w="100%" p="7px 18px 0 0" alignItems="center" mt="9px">
                ...
                <Flex border="1px solid #FFFFFF" w="548px" h="101px" ml="26px" borderRadius="6px" cursor="pointer">
...
export const AllBets = observer(() => {
    ...
    return (
        <Flex h="400px" flexDir="column" overflowY="scroll" mt="13px" ml="50px">
            <Text fontSize="18px" fontWeight="400">
                Сессии без приоритета
            </Text>
            {
